					...
					<div class="content">
						<div class=row>
							<div class="col-md-4 text-center">
								<a href="{{ url('OfficeSecrerariat/TechnicalAndQualityImprovement/EducationServiceBachelor/gallery/activity1') }}">
									<div class="gallery">
							...
							<div class="col-md-4 text-center">
								<a href="{{ url('OfficeSecrerariat/TechnicalAndQualityImprovement/EducationServiceBachelor/gallery/activity2') }}">
									<div class="gallery">
							...
							<div class="col-md-4 text-center">
								<a href="{{ url('OfficeSecrerariat/TechnicalAndQualityImprovement/EducationServiceBachelor/gallery/activity3') }}">
									<div class="gallery">
							...
							<div class="col-md-4 text-center">
								<a href="{{ url('OfficeSecrerariat/TechnicalAndQualityImprovement/EducationServiceBachelor/gallery/activity4') }}">
									<div class="gallery">
