					...
					<div class="content">
						<div class=row>
							<div class="col-md-4 text-center">
								<a href="{{ url('degree/bachelor/gallery/activity1') }}">
									<div class="gallery">
							...
							<div class="col-md-4 text-center">
								<a href="{{ url('degree/bachelor/gallery/activity2') }}">
									<div class="gallery">
							...
							<div class="col-md-4 text-center">
								<a href="{{ url('degree/bachelor/gallery/activity3') }}">
									<div class="gallery">
							...
							<div class="col-md-4 text-center">
								<a href="{{ url('degree/bachelor/gallery/activity4') }}">
									<div class="gallery">
