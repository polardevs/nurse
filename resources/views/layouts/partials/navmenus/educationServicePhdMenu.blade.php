<div class="panel-group" id="accordion" aria-multiselectable="true">
	...
	<div class="panel panel-default">
		...
		<div id="collapseFive" class="panel-collapse collapse" >
			<a href="{{ url('OfficeSecrerariat/TechnicalAndQualityImprovement/EducationServicePhd/Form/teacher') }}" target="_blank">
				<div class="panel-body">สำหรับอาจารย์และเจ้าหน้าที่</div>
			</a>
			<a href="{{ url('OfficeSecrerariat/TechnicalAndQualityImprovement/EducationServicePhd/Form/student') }}" target="_blank">
	...
	<div class="panel panel-default">
		...
		<div id="collapseSix" class="panel-collapse collapse" >
			<a href="{{ url('OfficeSecrerariat/TechnicalAndQualityImprovement/EducationServicePhd/Download/student') }}" target="_blank">
				<div class="panel-body">สำหรับนักศึกษา</div>
			</a>
			<a href="{{ url('OfficeSecrerariat/TechnicalAndQualityImprovement/EducationServicePhd/Download/teacher') }}" target="_blank">
	...
	<div class="panel panel-default">
		<div class="panel-heading" id="headingTwo">
			<h4 class="panel-title">
				...
				<!-- <a class="collapsed" href="{{ url('OfficeSecrerariat/TechnicalAndQualityImprovement/EducationServicePhd/assessment') }}"> -->
